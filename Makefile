...
common.o: common.c hgd.h
	${CC} ${CPPFLAGS} ${CFLAGS} ${SSL_LD_FLAGS} -c -o common.o common.c

db.o: db.c hgd.h
	${CC} ${CPPFLAGS} ${SQL_CPPFLAGS} ${CFLAGS} -c -o db.o db.c

hgd-playd: common.o db.o hgd-playd.c hgd.h
	${CC} ${CPPFLAGS} ${SQL_CPPFLAGS} ${CFLAGS} ${SQL_LDFLAGS} ${SSL_LD_FLAGS} ${LDFLAGS} \
...
hgdc: common.o hgdc.c hgd.h
	${CC} ${CPPFLAGS} ${CFLAGS} ${LDFLAGS} ${SSL_LD_FLAGS} -o hgdc common.o hgdc.c
